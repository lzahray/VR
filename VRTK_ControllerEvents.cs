namespace VRTK
{
    ...
    public class VRTK_ControllerEvents : MonoBehaviour
    {
        ...
        public ButtonAlias reshapeToggleButton = ButtonAlias.Trigger; 
        ...
        public bool reshapePressed = false;
        ...
        public event ControllerInteractionEventHandler AliasReshapeOn; //this is for the bottle scene
        public event ControllerInteractionEventHandler AliasReshapeOff;
        ...
        public virtual void OnAliasReshapeOn(ControllerInteractionEventArgs e)
        {
            if (AliasReshapeOn != null)
                AliasReshapeOn(this, e);
        }

        public virtual void OnAliasReshapeOff(ControllerInteractionEventArgs e)
        {
            if (AliasReshapeOff != null)
                AliasReshapeOff(this, e);
        }
        ...
        private void EmitAlias(ButtonAlias type, bool touchDown, float buttonPressure, ref bool buttonBool)
        {
            ...
            if (reshapeToggleButton == type)
            {
                if (touchDown)
                {
                    reshapePressed = true;                  
                    OnAliasReshapeOn(SetButtonEvent(ref buttonBool, true, buttonPressure));
                }
                else
                {
                    reshapePressed = false;
                    OnAliasReshapeOff(SetButtonEvent(ref buttonBool, false, buttonPressure));
                }
            }
        }
